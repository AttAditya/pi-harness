...
import { createExitTool, createExitToolDefinition } from "./exit.ts";
...
export type ToolName = "read" | "bash" | "powershell" | "edit" | "write" | "grep" | "find" | "ls" | "exit";
...
export function createToolDefinition(toolName: ToolName, cwd: string, options?: ToolsOptions): ToolDef {
	switch (toolName) {
		...
		case "exit":
			return createExitToolDefinition();
		default:
